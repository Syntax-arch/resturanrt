...
<body>
  ...
  <div class="container mt-4">
    ...
    <div class="row mb-4">
      ...
      <div class="col-md-3 mb-3">
        <div class="quick-action" data-bs-toggle="modal" data-bs-target="#profileModal" style="cursor: pointer;">
          <div class="h1 mb-3">👤</div>
          <h5>プロフィール</h5>
      ...
      <div class="col-md-3 mb-3">
        <div class="quick-action" onclick="showHelp()" style="cursor: pointer;">
          <div class="h1 mb-3">❓</div>
          <h5>ヘルプ</h5>
